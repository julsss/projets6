...
public class Fenetre implements Runnable{
	...
	public JFrame frame;
	public JButton annuler, refaire, playIA;
	...
	public void run() {
		...
		EcouteurFenetre f = new EcouteurFenetre(this);
		...
		playIA = new JButton("faire Jouer IA");
		...
		alpha.putConstraint(SpringLayout.HORIZONTAL_CENTER, playIA, 0, SpringLayout.HORIZONTAL_CENTER,frame);
		alpha.putConstraint(SpringLayout.SOUTH, playIA, -80, SpringLayout.SOUTH,frame);
